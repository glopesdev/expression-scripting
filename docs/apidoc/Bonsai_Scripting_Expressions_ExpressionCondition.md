...
[!include[](../articles/expression-language.md)]

### Examples

The following examples demonstrate common condition filters achievable with this operator. Elements that evaluate to `true` will pass the filter, while elements that evaluate to `false` will be dropped from the output sequence.
